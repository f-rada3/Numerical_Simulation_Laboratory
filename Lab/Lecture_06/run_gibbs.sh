...
# ============================================================
# NSL Exercise 06.1 - Automatic temperature scan (Gibbs)
# T: 2.0 -> 0.5 step -0.05
# ============================================================
...
ARCHIVE_BASE="$SIM_DIR/OUTPUT_gibbs"

# Parametri simulazione
SIM_TYPE=3          # 2 = Metropolis, 3 = Gibbs
JCOUP=1.0
NPART=50
RHO=1.0
RCUT=0
...
# per renderlo eseguibile: $ chmod +x run_gibbs.sh
# per avviarlo: ./run_gibbs.sh