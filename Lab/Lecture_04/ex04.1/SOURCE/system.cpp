...
void System :: read_configuration(){
  ...
  if(cinf.is_open()){
    ...
    for(int i=0; i<_npart; i++){
      ...
      _particle(i).setposition(0, this->pbc(_side(0)*x, 0)); // When starting the simulation, we have to multiply by _side, as we want the system to be contained in a box of side equal to _side
